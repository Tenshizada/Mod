package com.tenshi.tenshisadditions.block;
...
public class ModBlocks {
    public static final DeferredRegister.Blocks BLOCKS =
            DeferredRegister.createBlocks(TenshisAdditions.MOD_ID);

    public static final DeferredBlock<Block> ALVES_BLOCK = registerBlock("alves_block",
    ...
    public static final DeferredBlock<Block> TEST_BLOCK = registerBlock("test_block",
            () -> new DropExperienceBlock(UniformInt.of(2, 4),
                    BlockBehaviour.Properties.of().strength(3f).sound(SoundType.STONE)));
